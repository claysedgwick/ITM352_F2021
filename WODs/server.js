            ...
            for (k = 0; k < products.length; k++) {
                if (products[k].id_number == request.cookies["id_ordered" + i]) {
                    ...
                    if (quant > 0) {
                        ...
                        // product row
                        if (quant > products[i].quantity_available) {
                            str += (`
                            <tr>
...
app.get("/itemsadded", function (request, response) {
    ...
    function display_items_added() {
        ...
        str += (`<br><div class="welcome2">Hey<b>${" " + displayName}</b>! The following has been added to your shopping cart:</div><br><div class="welcome">`);
        for (i = 0; i < products.length; i++) {
...
app.get("/cart", function (request, response) {
    ...
    let loginCheck = request.cookies["loggedIn"];
    ...
    function display_cart() {
        ...
        str += (`<br><div class="welcome2">Hey<b>${" " + displayName}</b>! Here's what's in your shopping cart:</div><br>`);
        ...
        if (str_add == '') {
            ...
            if (loginCheck.toString() == "yes" && loginCheck != undefined) {
                str_add += `
                <br>
                <div class="navBar">
